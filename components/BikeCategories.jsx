        ...
        <div className="flex flex-col">
          ...
          <aside className="w-full p-4 mb-8 xl:w-[300px] xl:h-[84vh] xl:fixed">
            <RadioGroup defaultValue="all" className="flex flex-col gap-6 mb-12">
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="professionnal" id="professionnal" onClick={() => setCategory("professionnal")} />
            ...
            <div className="max-w-56">
              <div className="text-lg mb-4 font-medium">
                Prix Maximum : <span className="text-accent font-semibold ml-2">{price}€</span>
                <span className="ml-2">({filteredBikes.length > 1 ? `${filteredBikes.length} items` : filteredBikes === 0 ? `${filteredBikes.length}) items` : `${filteredBikes.length} item`}</span>
              </div>
