          ...
          <div className="flex-1 flex flex-col justify-center items-start gap-10">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex gap-2">
                <PackageCheck size={20} className="text-red-500" />
                <p>Pas de frais de livraison au dessus de 130€.</p>
              </div>
              <div className="flex gap-2">
              ...
              <div className="flex gap-2">
                ...
                <p>Nos vélos sont partiellement assemblés et bénéficits de l'assurance transport.'</p>
              </div>
              <div className="flex gap-2">
